...
addButton.addEventListener("click",function (e) {
  ...
  employee.passWord=`Zahid2003`
  employee.fullName = "Zahid Haydarli"
...
loginButton.addEventListener("click", (e) => {
  ...
  if (enteredLogin === "Zahid Haydarli" && enteredPassword === "Zahid2003") {
    loginContainer.style.opacity = 0
    informationContainer.style.opacity = 1
    loginContainer.style.zIndex = -2
    informationContainer.style.zIndex = 1
  } else if (enteredLogin === "Zahid Haydarli" && enteredPassword === "Zahid2003") {
